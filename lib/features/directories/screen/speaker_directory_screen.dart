...
class _SpeakerDirectoryScreenState extends ConsumerState<SpeakerDirectoryScreen> {
  ...
  List<AppUser> _applySearchAndPrivacyFilter(List<AppUser> speakers, AppUser? currentUser) {
      ...
      children: [
        ...
        Expanded(
          child: currentUserAsync.when(
            data: (currentUser) {
              if (currentUser == null) {
                return const Center(child: Text('Please log in to view speakers.'));
              }
              ...
              return speakersAsync.when(
                data: (speakers) {
                  ...
                  final filteredSpeakers = _applySearchAndPrivacyFilter(speakers, currentUser);
